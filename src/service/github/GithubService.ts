...
export class GithubService {
    ...
    getPullRequestDiff = async (owner: string, repo: string, number: number): Promise<string> => {
    ...
    createComment = async (owner: string, repo: string, number: number, comments: Array<Comment>): Promise<void> => {
